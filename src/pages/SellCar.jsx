          ...
          <div className="offer__list">
            <div className="offer__item">
              <div className="box__01">
                <h3 className="client__name">James</h3>
                <h6 className="avg__price">
                  Rs.14,87,605 <span>average price</span>
                </h6>

                <h6 className="market__price">Market average is Rs.1353249</h6>
              ...
              <div className="box__03">
                ...
                <h6 className="spend__amount">Rs.97803</h6>
              ...
              <div className="box__04">
                ...
                <h6 className="spend__amount">Rs.88503</h6>
                <p className="spend__title">Model Spend</p>
              </div>
              ...
              <div className="box__05">
                ...
                <h6 className="spend__amount">Rs.67562</h6>
                <p className="spend__title">Spend Per Unit Turned</p>
              </div>
            </div>
            <div className="offer__item">
              <div className="box__01">
                <h3 className="client__name">Ram</h3>
                <h6 className="avg__price">
                  Rs.10,45,605 <span>average price</span>
                </h6>

                <h6 className="market__price">Market average is Rs.936711</h6>
                <span className="arrow__key">
                  <i class="ri-arrow-right-line"></i>
                </span>
              </div>
              ...
              <div className="box__04">
                ...
                <h6 className="spend__amount">Rs.647803</h6>
                <p className="spend__title">Model Spend</p>
              </div>
